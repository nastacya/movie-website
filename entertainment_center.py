...
baby_driver = media.Movie("Baby driver",
                          "Talented getaway driver Baby relies on the beat of his personal soundtrack to be the best in the game. After meeting the woman of his dreams, he sees a chance to ditch his shady lifestyle and make a clean break.",
...
gifted = media.Movie("Gifted",
                     "Frank Adler is a single man raising a child prodigy - his spirited young niece Mary - in a coastal town in Florida. Frank's plans for a normal school life for Mary are foiled when the 7-year-old's mathematical abilities come to the attention of Frank's formidable mother",
...
mother = media.Movie("Mother",
                     "A couple's relationship is tested when uninvited guests arrive at their home, disrupting their tranquil existence. From filmmaker Darren Aronofsky (Black Swan, Requiem for a Dream)",
                     "https://upload.wikimedia.org/wikipedia/en/9/94/Mother%212017.jpg",
                     "https://www.youtube.com/watch?v=XpICoc65uh0")

logan_lucky = media.Movie("Logan lucky",
                          "West Virginia family man Jimmy Logan teams up with his one-armed brother Clyde and sister Mellie to steal money from the Charlotte Motor Speedway in North Carolina. Jimmy also recruits demolition expert Joe Bang to help them break into the track's underground system.",
...
suicide_squad = media.Movie("Suicide squad",
                            "Figuring they're all expendable, a U.S. intelligence officer decides to assemble a team of dangerous, incarcerated supervillains for a top-secret mission. Now armed with government weapons, Deadshot, Harley Quinn, Captain Boomerang, Killer Croc and other despicable inmates must learn to work together.",
                            "https://upload.wikimedia.org/wikipedia/en/5/50/Suicide_Squad_%28film%29_Poster.png",
                            "https://www.youtube.com/watch?v=CmRih_VtVAs")

martian = media.Movie("The Martian",
                      "When astronauts blast off from the planet Mars, they leave behind Mark Watney, presumed dead after a fierce storm. With only a meager amount of supplies, the stranded visitor must utilize his wits and spirit to find a way to survive on the hostile plane",
                      "https://upload.wikimedia.org/wikipedia/en/c/cd/The_Martian_film_poster.jpg",
                      "https://www.youtube.com/watch?v=ej3ioOneTy8")

furious_seven = media.Movie("Furious 7",
                            "After defeating international terrorist Owen Shaw, Dominic Toretto, Brian O'Conner and the rest of the crew have separated to return to more normal lives. However, Deckard Shaw, Owen's older brother, is thirsty for revenge.",
...
everest = media.Movie("Everest",
                      "On the morning of May 10, 1996, climbers from two expeditions start their final ascent toward the summit of Mount Everest, the highest point on Earth. With little warning, a violent storm strikes the mountain, engulfing the adventurers in one of the fiercest blizzards ever encountered by man.",
                      "https://upload.wikimedia.org/wikipedia/en/2/28/Everest_poster.jpg",
                      "https://www.youtube.com/watch?v=5ZQVpPiOji0")

intern = media.Movie("The intern",
                     "Starting a new job can be a difficult challenge, especially if you're already retired. Looking to get back into the game, 70-year-old widower Ben Whittaker seizes the opportunity to become a senior intern at an online fashion site. Ben soon becomes popular with his younger co-workers, including Jules Ostin, the boss and founder of the company.",
                     "https://upload.wikimedia.org/wikipedia/en/c/c9/The_Intern_Poster.jpg",
                     "https://www.youtube.com/watch?v=ZU3Xban0Y6A")

bachelors = media.Movie("The Bachelors",
                        "After the death of his wife, Bill and his 17-year-old son, Wes, move from a small town to a big city for a fresh start. As they begin to adjust to life in the city and seek ways to heal their wounds, they both find comfort in newfound romances.",
...
southpaw = media.Movie("Southpaw",
                       "Billy The Great-Hope, the reigning junior middleweight boxing champion, has an impressive career, a loving wife and daughter, and a lavish lifestyle. However, when tragedy strikes, Billy hits rock bottom, losing his family, his house and his manager.",
                       "https://upload.wikimedia.org/wikipedia/en/8/89/Southpaw_poster.jpg",
                       "https://www.youtube.com/watch?v=Mh2ebPxhoLs")

movies = [avengers, only_the_brave, get_out, logan, wind_river, wonder, it, baby_driver, coco, gifted, geostorm, mother,
          logan_lucky, suicide_squad, martian, furious_seven, revenant, everest, intern, bachelors, southpaw]
